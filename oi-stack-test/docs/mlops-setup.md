...
[ML Config](../oi_stack_test/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore oi_stack_test/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [oi-stack-test/databricks.yml](../oi_stack_test/databricks.yml)
and [oi-stack-test/assets/ml-artifacts-asset.yml](../oi_stack_test/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [oi-stack-test/assets/README.md](../oi_stack_test/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../oi_stack_test/assets/README.md)  to propose, test, and deploy
