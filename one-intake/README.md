...
and [ML asset config guide](one_intake/assets/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML assets, e.g. model training or inference jobs  | [ML asset config guide](one_intake/assets/README.md)                                                     |
