...
# ``oi_stack_test/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-oi-stack-test-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.sbox_ml.oi-stack-test-model", label="Full (Three-Level) Model Name"
)
