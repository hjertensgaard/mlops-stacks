...
```
oi-stack-test        <- Root directory. Both monorepo and polyrepo are supported.
│
├── oi_stack_test       <- Contains python code, notebooks and ML assets related to one ML project. 
│   │
...
and [ML asset config guide](oi_stack_test/assets/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML assets, e.g. model training or inference jobs  | [ML asset config guide](oi_stack_test/assets/README.md)                                                     |
