...
[ML Config](../one_intake/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore one_intake/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [one-intake/databricks.yml](../one_intake/databricks.yml)
and [one-intake/assets/ml-artifacts-asset.yml](../one_intake/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [one-intake/assets/README.md](../one_intake/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../one_intake/assets/README.md)  to propose, test, and deploy
